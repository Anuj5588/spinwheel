(function () {
  ...
  function alertResult(actualDeg) {
    ...
    if (actualDeg >= 0 && actualDeg <= 30) {
      ...
      colorResult.innerHTML = "gift8";
      // Set button style
      root.style.setProperty("--linear-shadow", result);
    } else if (actualDeg > 240 && actualDeg <= 270) {
      result = "#ff0066";

      colorResult.innerHTML = "gift9";
      ...
      colorResult.innerHTML = "gift10";

      // Set button style
      root.style.setProperty("--linear-shadow", result);
    } else if (actualDeg > 300 && actualDeg <= 330) {
      result = "#ff6601";
      colorResult.innerHTML = "gift11";

      // Set button style
      root.style.setProperty("--linear-shadow", result);
    } else if (actualDeg > 330 && actualDeg <= 360) {
      result = "#ffcc01";
      colorResult.innerHTML = "gift12";
    }
